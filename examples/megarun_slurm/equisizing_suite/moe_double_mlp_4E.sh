...
CHECKPOINT_PATH=/checkpoints/equiparam/double_mlp_4e
...
EXPERT_STATS_PATH=/checkpoints/equiparameter/double_mlp_4e

WANDB_PROJECT=moe_equiparam
WANDB_EXP_NAME=doube_mlp_4e
WANDB_SAVE_DIR=/checkpoints/equiparam/wandb_double_mlp_4e
